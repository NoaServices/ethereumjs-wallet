...
`var thirdparty = require('@tsiry/ethereumjs-wallet/thirdparty')`
...
`var hdkey = require('@tsiry/ethereumjs-wallet/hdkey')`
...
```js
const WalletSubprovider = require('@tsiry/ethereumjs-wallet/provider-engine')
